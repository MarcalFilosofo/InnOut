    ...
    <form action="#" method="POST">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="password" id="confirm_password" name="confirm_password" placeholder="Informe o E-mail"
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="date" id="end_date" name="end_date" placeholder="Informe o seu nome"
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="checkbox" id="is_admin" name="is_admin" placeholder="Informe o seu nome"
